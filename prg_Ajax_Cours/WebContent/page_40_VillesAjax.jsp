...
<!DOCTYPE html>
			...
			function initialise()
			{
				var url="SrvAnimes?action=choixPays";
				//var requete	
			...
			function showRegions(val){
				...
				var url="SrvAnimes?action=choixRegion&region="+ val
				var requete = new XMLHttpRequest();
			...
			function showDept(val){
				if(val === "")return;
				var url="SrvAnimes?action=choixDept&dept="+ val
				var requete = new XMLHttpRequest();
			...
			function showCities(val){
				if(val === "")return;
				var url="SrvAnimes?action=choixVille&cities="+ val
				var requete = new XMLHttpRequest();
